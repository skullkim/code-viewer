...
|--------|------|---------------|------|-----------|
| REQ-007 AC-1 | backend | `FuzzyMatcherTests` (9) — 부분수열 매칭·대소문자 무시·불일치·강조 구간·점수 순위 | backend-junior | PASS |
...
- REQ-006·008은 `ReferenceSearcher`·`TextSearcher`(BE-08·09)가 이 빌더를 실제로 쓰는 테스트가 있어야 닫힌다.
