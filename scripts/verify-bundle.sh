...
check_wiring() {
    local output="$1"
    local wire
    for wire in terminal debugger detector; do
...
self_test() {
    ...
    WIRED_FIXTURE='rootView=laidOut menus=9 terminal=wired debugger=wired detector=wired'
    MISSING_FIXTURE='rootView=laidOut menus=9 terminal=MISSING debugger=wired detector=wired'
